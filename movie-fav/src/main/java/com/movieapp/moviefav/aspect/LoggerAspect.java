package com.movieapp.moviefav.aspect;
...
public class LoggerAspect {
   ...
   @Before(value="execution(* com.movieapp.moviefav.controller..*(..)))")
   ...
   @After(value="execution(* com.movieapp.moviefav.controller..*(..)))")
   ...
   @AfterReturning(value="execution(* com.movieapp.moviefav.controller..*(..)))",returning = "result")
   ...
   @AfterThrowing(value="execution(* com.movieapp.moviefav.controller..*(..)))")
